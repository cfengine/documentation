...
**ADD DIGITAL OCEAN SCREENSHOT HERE**
...
```
$ export HUB="128.199.44.119"
$ export SSH="root@128.199.44.119"
```
...
On your development machine, use `cf-remote` to install CFEngine on the Linux VM:
