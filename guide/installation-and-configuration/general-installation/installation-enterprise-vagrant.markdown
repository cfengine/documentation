...
[tar-file](https://cfengine-package-repos.s3.amazonaws.com/enterprise/Enterprise-3.7.6/misc/CFEngine_Enterprise_vagrant_quickstart-{{site.cfengine.branch}}.{{site.cfengine.latest_patch_release}}-{{site.cfengine.latest_package_build}}.tar.gz).
