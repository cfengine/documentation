...
def run(config):
    """ Fixes images paths.
        if markdown file will be generated is /directory/index.html and this directory will be no
        images as they initally locate on the previous level.
    """
...
def process(file_path):
    ...
    try:
        ...
        # Pattern to match img srs with relative paths that need fixing
        # skips ../, /, or http
