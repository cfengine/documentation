...
[%CFEngine_include_markdown(editing_password_or_group_files.cf)%]
...
[%CFEngine_include_markdown(editing_password_or_group_files_custom.cf)%]

## Log rotation


[%CFEngine_include_markdown(log_rotation.cf)%]

## Garbage collection


[%CFEngine_include_markdown(garbage_collection.cf)%]
...
[%CFEngine_include_markdown(simple_template.cf)%]
...
[%CFEngine_include_markdown(simple_versioned_template.cf)%]
...
[%CFEngine_include_markdown(macro_template.cf)%]

The macro template file may contain variables, as below, that get expanded by CFEngine.


[%CFEngine_include_markdown(macro_template_1.cf)%]
...
[%CFEngine_include_markdown(custom_editing.cf)%]
...
[%CFEngine_include_markdown(custom_editing_1.cf)%]
