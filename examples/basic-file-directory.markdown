...
[%CFEngine_include_markdown(create_files_and_directories.cf)%]
...
[%CFEngine_include_markdown(copy_single_files.cf)%]
...
[%CFEngine_include_markdown(copy_directory_trees.cf)%]
...
[%CFEngine_include_markdown(disabling_and_rotating_files.cf)%]
...
[%CFEngine_include_markdown(add_lines_to_a_file.cf)%]

Also you could write this using a list variable:


[%CFEngine_include_markdown(add_lines_to_a_file_1.cf)%]

## Check file or directory permissions


[%CFEngine_include_markdown(check_file_or_directory_permissions.cf)%]

## Commenting lines in a file


[%CFEngine_include_markdown(commenting_lines_in_a_file.cf)%]

## Copy files


[%CFEngine_include_markdown(copy_files.cf)%]
...
[%CFEngine_include_markdown(copy_and_flatten_directory.cf)%]
...
[%CFEngine_include_markdown(copy_then_edit_a_file_convergently.cf)%]
...
[%CFEngine_include_markdown(creating_files_and_directories.cf)%]

## Deleting lines from a file


[%CFEngine_include_markdown(deleting_lines_from_a_file.cf)%]

## Deleting lines exception


[%CFEngine_include_markdown(deleting_lines_exception.cf)%]
...
[%CFEngine_include_markdown(editing_files.cf)%]


## Editing tabular files


[%CFEngine_include_markdown(editing_tabular_files.cf)%]

## Inserting lines in a file


[%CFEngine_include_markdown(inserting_lines_in_a_file.cf)%]

## Back references in filenames


[%CFEngine_include_markdown(back_references_in_filenames.cf)%]

## Add variable definitions to a file


[%CFEngine_include_markdown(add_variable_definitions_to_a_file.cf)%]
...
[%CFEngine_include_markdown(add_variable_definitions_to_a_file_1.cf)%]

## Linking files


[%CFEngine_include_markdown(linking_files.cf)%]

## Listing files-pattern in a directory


[%CFEngine_include_markdown(listing_files-pattern_in_a_directory.cf)%]

## Locate and transform files


[%CFEngine_include_markdown(locate_and_transform_files.cf)%]

## BSD flags ##


[%CFEngine_include_markdown(bsd_flags.cf)%]

## Search and replace text


[%CFEngine_include_markdown(search_and_replace_text.cf)%]

## Selecting a region in a file


[%CFEngine_include_markdown(selecting_a_region_in_a_file.cf)%]

## Warn if matching line in file

[%CFEngine_include_markdown(warn_if_matching_line_in_file.cf)%]
