...
is [/api/settings][Users and Access-Control REST API#Get settings], which returns the singleton resource for settings. 
...
configurable through [/api/settings][Users and Access-Control REST API#Update settings].
