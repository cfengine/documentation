...
bundle agent example
{
  defaults:
    "X"
      string => "I am a default value";
    "Y"
      slist => {
        "I am a default list item 1",
        "I am a default list item 2",
      };

  methods:
    "example"
      usebundle => mymethod("","bbb");
...
vars:
  "no_return"
    string => "ok"; # readfile("/dont/exist","123");
