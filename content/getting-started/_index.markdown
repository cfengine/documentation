...
With its flexible and performant reporting system, you can have up-to-date inventory and compliance reports even with hundreds of thousands of endpoints under management.
...
3. [Part 2: Using the CFEngine Web UI][Using the CFEngine Web UI]
2. [Part 3: Adding modules from CFEngine Build][Adding modules from CFEngine Build]
