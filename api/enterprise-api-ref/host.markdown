...
After 5-10 minutes (one reporting iteration based on the [hub schedule][component-cf-hub#hub_schedule]), the main thread of cf-hub will pick up the deletion job.
